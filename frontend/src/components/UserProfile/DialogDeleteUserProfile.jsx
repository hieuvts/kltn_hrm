...
export default function DialogDeleteUserProfile({
  isDialogOpen,
  handleCloseDialog,
}) {
        ...
        <DialogTitle>
          ...
          >
            <Typography variant="h5">
              Are you sure you want to delete this UserProfile? <br /> <br />
              This will delete the UserProfile and all of its information (employee
              list, project list,...)
            </Typography>
...
DialogDeleteUserProfile.propTypes = {
