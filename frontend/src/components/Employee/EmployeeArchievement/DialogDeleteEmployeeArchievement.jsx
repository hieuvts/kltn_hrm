...
export default function DialogDeleteEmployeeArchievement({
  isDialogOpen,
  handleCloseDialog,
}) {
  ...
  const selectedEmployeeId = useSelector(
    (state) => state.employee.currentSelectedEmployee.id
  );
      ...
      <Dialog open={isDialogOpen} onClose={handleCloseDialog} maxWidth="md">
        <DialogTitle>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            <Typography variant="h4">Are you sure you want to delete this archievement?</Typography>
...
DialogDeleteEmployeeArchievement.propTypes = {
